...
##Pmod Header JC                                                                                                                  
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { uart_tx_serial }]; #IO_L10P_T1_34 Sch=jc_p[1] jc[0]  			 
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { uart_rx_serial }]; #IO_L10N_T1_34 Sch=jc_n[1]	jc[1]	     
...
##Pmod Header JE     
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_serial }]; #IO_L4P_T0_34 Sch=je[1]		je[0]				 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { uart_rx_serial }]; #IO_L18N_T2_34 Sch=je[2]           je[1]          
